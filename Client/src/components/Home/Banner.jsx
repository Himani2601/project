...
const Banner = () => {
    return (
        <section className="banner relative h-screen overflow-hidden bg-cover bg-center flex justify-center items-center">
            <img src={backgroundImage} className="absolute z-0 inset-0 mx-auto my-auto w-[90vw] h-[80vh] object-cover rounded-xl" alt="Banner Background" />
            <div className="banner-content text-center text-white flex flex-col justify-center items-center md:w-[60vw] backdrop-filter backdrop-blur-sm bg-black bg-opacity-20 rounded-lg shadow-md px-6 w-[80vw] h-[70vh] md:h-[50vh] sm:w-auto">
