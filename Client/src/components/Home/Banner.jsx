...
const Banner = () => {
    return (
        <section className="banner relative h-screen overflow-hidden bg-cover bg-center flex justify-center items-center">
            ...
            <div className="banner-content text-center text-white flex flex-col justify-center items-center sm:w-[80vw] lg:w-[65vw] backdrop-filter backdrop-blur-sm bg-gray-800 bg-opacity-20 rounded-lg shadow-md px-6 w-[80vw] h-[70vh] sm:h-[50vh] animate-fade-in">
